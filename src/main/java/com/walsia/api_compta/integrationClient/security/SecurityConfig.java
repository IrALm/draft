...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, EmailVerifieFilter emailVerifieFilter) throws Exception {
        http
                ...
                .addFilterAfter(emailVerifieFilter, BearerTokenAuthenticationFilter.class);
        return http.build();
    }

    /** Autorise le frontend (Angular, dev local) à appeler l'API depuis une autre origine. */
    ...
    /** Traduit les rôles realm Keycloak (realm_access.roles) en GrantedAuthority ROLE_xxx. */
